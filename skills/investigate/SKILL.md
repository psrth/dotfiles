---
name: investigate
description: Fan out subagents over hypotheses until the root cause is proven. Use when the user invokes /investigate, says debug/diagnose, or reports something broken, throwing, failing, flaky, or slow.
---
...
- Leverage all the tools at your disposal, using parallel subagents: whether it's MCP tools, code exploration, GitHub history, etc.
...
- Unless a bug / issue is immediately obvious — in which case surface it to the user immediately!! — kick off as many subagents to explore different hypotheses you may have.
