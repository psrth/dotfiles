_Vendored 2026-07-27 from [mattpocock/skills — writing-great-skills/GLOSSARY.md](https://github.com/mattpocock/skills/blob/main/skills/productivity/writing-great-skills/GLOSSARY.md); skill link repointed to this skill's SKILL.md, content otherwise verbatim._

# Glossary — Building Great Skills

The domain model for what makes a skill great. A skill exists to wrangle determinism out of a stochastic system; the root virtue is **Predictability**, and every term below is a lever on it. This is the disclosed reference for [`writing-a-skill`](../SKILL.md).
